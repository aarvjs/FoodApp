...
export default function AdminDeliveryChargesPage() {
  ...
  useEffect(() => {
    if (activeBranch) {
      ...
      setGstNumberInput(activeBranch.gstNumber || "");
        ...
        <form onSubmit={handleSaveTaxPercentage} className="space-y-4 max-w-xl">
          ...
          <div className="pt-2 border-t border-slate-100">
            ...
            <input
              ...
              maxLength={15}
              className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 uppercase font-mono"
            />
